      ...
      <div className="card w-full  text-black border shadow-md">
        <div className="card-body">
          ...
          <div className="card-actions flex w-[80%] justify-between items-center my-3">
            {/* <button className="btn" onClick={() => handleUpdateStatus(e._id)}>
              Update
            </button> */}
            <div>
              <button className="p-2 bg-[#ff006e] text-white rounded-md text-sm hover:scale-105 transition-all duration-300 flex items-center justify-center">
                <svg
                ...
                <span className="ml-2 font-semibold"> Update</span>
              </button>
            </div>
            {/* <button
