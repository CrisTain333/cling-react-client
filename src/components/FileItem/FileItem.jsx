...
const FileItem = ({ item }) => {
    ...
    return (
        ...
        <div className="overflow-x-auto my-2" style={{ border: "0.1rem solid #a557f7", borderRadius: "1rem" }}>
            <table className="table w-full">
                <tbody>
                    <tr>
                        <td className='font-bold' style={{ marginTop: "0px", width: "20%",paddingTop:"0.1rem",paddingBottom:"0.1rem" }}>{item.userId ? item.userId : "Employee"}</td>
                        <td style={{ marginTop: "0px",paddingTop:"0.1rem", width: "40%" ,paddingBottom:"0.1rem"}}>{val}</td>
                        <td style={{ marginTop: "0px",paddingTop:"0.1rem", width: "15%",paddingBottom:"0.1rem" }}><button className='btn' onClick={handleOpen}>Open Pdf</button></td>
                        <td style={{ marginTop: "0px",paddingTop:"0.1rem", width: "5%",paddingBottom:"0.1rem" }}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 mr-4">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                            </svg>
                        </td>
